...
We keep all important docs in `./docs` folder and keep updating them. Structure follows the **multi-language pattern** — English is canonical, translations live under `languages/{vi,zh,ko}/` mirroring the same filenames:

```
./docs
├── project-overview-pdr.md          ← English canonical
├── code-standards.md
├── codebase-summary.md
...
├── languages/
│   ├── vi/      ← Vietnamese translations (same filenames as root)
...
6. **Applies to all non-language subfolders of `docs/`.** If you create `docs/guides/onboarding.md`, also create `docs/languages/vi/guides/onboarding.md` (and zh, ko).
7. **Translation scope:** translate prose, headings, link text. Preserve code blocks, inline code, file paths, URLs, function/type/variable names, and project-specific identifiers verbatim.
