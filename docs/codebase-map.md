...
> 🌐 **Language:** **English** · [Tiếng Việt](languages/vi/codebase-map.md) · [中文](languages/zh/codebase-map.md) · [한국어](languages/ko/codebase-map.md)
...
## Quick Reference: "Where do I add a new X?"

| Task | Location | Template/Notes |
|------|----------|---|
| **Add API endpoint** | `apps/api/src/modules/<resource>/` | See [backend-module.md](guides/backend-module.md) |
| **Add database table** | `apps/api/prisma/schema.prisma` | Add model, migrate, see [prisma-module.md](guides/prisma-module.md) |
| **Add Flutter screen** | `apps/mobile/lib/features/<feature>/` | See [flutter-feature.md](guides/flutter-feature.md) |
| **Add shared Flutter widget** | `apps/mobile/lib/shared/widgets/` | Used across multiple features |
| **Add translation string** | `apps/mobile/lib/l10n/app_<lang>.arb` | Add to ALL locales, see [i18n-guide.md](i18n-guide.md) |
...
**Module = feature cohesion** — each directory has:
...
**Feature = user-visible functionality** — each directory has:
