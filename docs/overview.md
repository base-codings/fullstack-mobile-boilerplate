...
> 🌐 **Language:** **English** · [Tiếng Việt](languages/vi/overview.md) · [中文](languages/zh/overview.md) · [한국어](languages/ko/overview.md)
...
- **Onboarding time:** New dev reads [getting-started.md](guides/getting-started.md) → full environment running in 15 min
...
→ [Local Development Setup](guides/getting-started.md) to clone and run locally

→ [System Architecture](architecture.md) for detailed component breakdown
