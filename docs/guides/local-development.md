...
> 🌐 **Language:** **English** · [Tiếng Việt](../languages/vi/guides/local-development.md) · [中文](../languages/zh/guides/local-development.md) · [한국어](../languages/ko/guides/local-development.md)
...
- **[Add Backend Module](./add-new-backend-module.md)** — create API endpoint
- **[Add Flutter Feature](./add-new-flutter-feature.md)** — build mobile screen
- **[Code Standards](../code-standards.md)** — conventions to follow
- **[Project Overview](../project-overview-pdr.md)** — understand scope
