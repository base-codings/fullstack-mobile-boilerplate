...
> 🌐 **Language:** **English** · [Tiếng Việt](../languages/vi/guides/add-new-backend-module.md) · [中文](../languages/zh/guides/add-new-backend-module.md) · [한국어](../languages/ko/guides/add-new-backend-module.md)
...
- Boilerplate set up locally ([local-development.md](./local-development.md))
...
**Next Steps:**
- [Add a Prisma Model](./add-prisma-module.md)
