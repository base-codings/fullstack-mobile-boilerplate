...
> 🌐 **언어:** [English](../../../guides/api-contract.md) · [Tiếng Việt](../../vi/guides/api-contract.md) · [中文](../../zh/guides/api-contract.md) · **한국어**
...
**참고:**
- [새로운 백엔드 모듈 추가](./backend-module.md)
- [Prisma 모듈 추가](./prisma-module.md)
