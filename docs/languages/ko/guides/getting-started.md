...
> 🌐 **언어:** [English](../../../guides/getting-started.md) · [Tiếng Việt](../../vi/guides/getting-started.md) · [中文](../../zh/guides/getting-started.md) · **한국어**
...
- **[백엔드 모듈 추가](./backend-module.md)** — API 엔드포인트 생성
- **[Flutter 기능 추가](./flutter-feature.md)** — 모바일 화면 구축
- **[코드 표준](../code-standards.md)** — 따를 규칙
- **[프로젝트 개요](../overview.md)** — 범위 이해
