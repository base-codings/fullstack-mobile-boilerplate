...
> 🌐 **언어:** [English](../../overview.md) · [Tiếng Việt](../vi/overview.md) · [中文](../zh/overview.md) · **한국어**
...
- **온보딩 시간:** 새 개발자가 [getting-started.md](guides/getting-started.md) 읽음 → 15분 내 전체 환경 실행
...
→ [로컬 개발 설정](guides/getting-started.md)에서 클론하고 로컬 실행

→ 상세한 컴포넌트 분석을 위해 [시스템 아키텍처](architecture.md)
