...
> 🌐 **언어:** [English](../../codebase-map.md) · [Tiếng Việt](../vi/codebase-map.md) · [中文](../zh/codebase-map.md) · **한국어**
...
| 작업 | 위치 | 템플릿/참고 |
|------|----------|---|
| **API 엔드포인트 추가** | `apps/api/src/modules/<resource>/` | [backend-module.md](guides/backend-module.md) 참고 |
| **데이터베이스 테이블 추가** | `apps/api/prisma/schema.prisma` | 모델 추가, 마이그레이션, [prisma-module.md](guides/prisma-module.md) 참고 |
| **Flutter 화면 추가** | `apps/mobile/lib/features/<feature>/` | [flutter-feature.md](guides/flutter-feature.md) 참고 |
| **공유 Flutter 위젯 추가** | `apps/mobile/lib/shared/widgets/` | 여러 기능에서 사용 |
| **번역 문자열 추가** | `apps/mobile/lib/l10n/app_<lang>.arb` | 모든 로캘에 추가, [i18n-guide.md](i18n-guide.md) 참고 |
