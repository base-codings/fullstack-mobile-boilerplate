...
> 🌐 **语言:** [English](../../../guides/api-contract-workflow.md) · [Tiếng Việt](../../vi/guides/api-contract-workflow.md) · **中文** · [한국어](../../ko/guides/api-contract-workflow.md)
...
**另见：**
- [添加新后端模块](./add-new-backend-module.md)
- [添加 Prisma 模块](./add-prisma-module.md)
