...
> 🌐 **语言:** [English](../../../guides/local-development.md) · [Tiếng Việt](../../vi/guides/local-development.md) · **中文** · [한국어](../../ko/guides/local-development.md)
...
- **[添加后端模块](./add-new-backend-module.md)** — 创建 API 端点
- **[添加 Flutter 功能](./add-new-flutter-feature.md)** — 构建移动屏幕
- **[代码标准](../code-standards.md)** — 要遵循的约定
- **[项目概览](../project-overview-pdr.md)** — 理解范围
