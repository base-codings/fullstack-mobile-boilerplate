...
> 🌐 **语言:** [English](../../project-overview-pdr.md) · [Tiếng Việt](../vi/project-overview-pdr.md) · **中文** · [한국어](../ko/project-overview-pdr.md)
...
- **入门时间:** 新开发者阅读 [local-development.md](guides/local-development.md) → 完整环境在 15 分钟内运行
...
→ [本地开发设置](guides/local-development.md) 克隆并在本地运行

→ [系统架构](system-architecture.md) 获取详细组件分解
