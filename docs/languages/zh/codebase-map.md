...
> 🌐 **语言:** [English](../../codebase-map.md) · [Tiếng Việt](../vi/codebase-map.md) · **中文** · [한국어](../ko/codebase-map.md)
...
| 任务 | 位置 | 模板/说明 |
|------|----------|---|
| **添加 API 端点** | `apps/api/src/modules/<resource>/` | 见 [backend-module.md](guides/backend-module.md) |
| **添加数据库表** | `apps/api/prisma/schema.prisma` | 添加模型、迁移、见 [prisma-module.md](guides/prisma-module.md) |
| **添加 Flutter 屏幕** | `apps/mobile/lib/features/<feature>/` | 见 [flutter-feature.md](guides/flutter-feature.md) |
| **添加共享 Flutter 组件** | `apps/mobile/lib/shared/widgets/` | 用于多个功能 |
| **添加翻译字符串** | `apps/mobile/lib/l10n/app_<lang>.arb` | 添加到所有语言，见 [i18n-guide.md](i18n-guide.md) |
