...
> 🌐 **Ngôn ngữ:** [English](../../i18n-tone-guide.md) · **Tiếng Việt** · [中文](../zh/i18n-tone-guide.md) · [한국어](../ko/i18n-tone-guide.md)

## Multi-Language Setup

App sử dụng **ARB (Application Resource Bundle)** format for translations. Files are in `apps/mobile/lib/l10n/`.
...
- **Avoid Anglicisms:** "đăng nhập" not "login", "lưu" is Vietnamese (use it), "hình ảnh" is native, "email" okay (no good equivalent)
