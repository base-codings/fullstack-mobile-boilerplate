# Thêm Một Flutter Feature Mới

> 🌐 **Ngôn ngữ:** [English](../../../guides/add-new-flutter-feature.md) · **Tiếng Việt** · [中文](../../zh/guides/add-new-flutter-feature.md) · [한국어](../../ko/guides/add-new-flutter-feature.md)

Hướng dẫn này hướng dẫn building một complete Flutter feature sử dụng repository pattern và Riverpod state management.
...
import '../../../shared/models/api_client_generated.dart';
...
**Next Steps:**
- [API Contract Workflow](./api-contract-workflow.md) — when backend DTOs change
