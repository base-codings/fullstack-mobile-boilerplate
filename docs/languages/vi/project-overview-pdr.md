# Tổng Quan Dự Án & Yêu Cầu Sản Phẩm

> 🌐 **Ngôn ngữ:** [English](../../project-overview-pdr.md) · **Tiếng Việt** · [中文](../zh/project-overview-pdr.md) · [한국어](../ko/project-overview-pdr.md)
...
Xem [Tổng Quan Kiến Trúc](system-architecture.md) để tìm hiểu chi tiết thêm.
